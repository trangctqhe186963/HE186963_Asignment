...
import controller.sendmail.Send;
import dal.UserDAO;
...
public class changeemail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ud.checkExit((String) request.getParameter("email")) == 1) {
            request.setAttribute("ms", "Email đã tồn tại");
            request.getRequestDispatcher("changeemail.jsp").forward(request, response);
        } else {
            ...
            boolean test = sm.sendEmailchangeinfor((String) request.getParameter("email"), code, "22");
            ss.setAttribute("email", (String) request.getParameter("email"));
